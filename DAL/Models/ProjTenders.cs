...
{
    public partial class ProjTenders
    {
        public ProjTenders()
        {
            ProjTendersDetails = new HashSet<ProjTendersDetails>();
        }
        ...
        public virtual ICollection<ProjTendersDetails> ProjTendersDetails { get; set; }
    }
}
