...
namespace DAL.Models
{
    public partial class StockOpenningBalance
    {
        ...
        {
            StockOpenningBalanceDetails = new HashSet<StockOpenningBalanceDetails>();
        }
        ...
        public virtual ICollection<StockOpenningBalanceDetails> StockOpenningBalanceDetails { get; set; }
    }
}
