...
namespace DAL.Models
{
    public partial class ProjTenderQoutation
    {
        ...
        {
            ProjTenderQoutationDetails = new HashSet<ProjTenderQoutationDetails>();
        }
        ...
        public virtual ICollection<ProjTenderQoutationDetails> ProjTenderQoutationDetails { get; set; }
    }
}
